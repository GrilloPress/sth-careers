...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou"> Developed by Sheffield Teaching Hospitals </span>.';
}
...
add_image_size( 'wpbs-featured', 100, true );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'sieve', 
      get_template_directory_uri() . '/library/js/sieve.js', 
      array('jquery'), 
      '1.2' );
